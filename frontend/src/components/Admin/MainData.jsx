...
import { FaMoneyBill, FaShoppingCart, FaBox, FaUsers } from 'react-icons/fa';
...
const MainData = () => {
  ...
  return (
    <>
      <MetaData title="Admin Dashboard | Digimart" />

      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-6 mb-6">
