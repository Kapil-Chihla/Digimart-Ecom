            ...
            {loading ? <Loader /> : (
                <>
                    ...
                    <main className="mt-12 sm:mt-0">
                        ...
                        <div className="w-full flex flex-col sm:flex-row  sm:p-2 relative bg-lightGrey">
                            ...
                            <div className="w-full sm:w-2/5 sm:sticky top-16 sm:h-screen">
                                ...
                                <div className="flex flex-col gap-3 m-3">
                                    ...
                                    <div className="w-full flex gap-3">
                                        {/* <!-- add to cart btn --> */}
                                        {product.stock > 0 && (
                                            <button onClick={itemInCart ? goToCart : addToCartHandler} className="p-2 w-1/2 flex items-center justify-center gap-2 text-white bg-primary-green rounded-sm shadow hover:shadow-lg">
                                                <ShoppingCartIcon />
                                                {itemInCart ? "GO TO CART" : "ADD TO CART"}
                                            </button>
                                        )}
                                        <button onClick={buyNow} disabled={product.stock < 1 ? true : false} className={product.stock < 1 ? "p-2 w-full flex items-center justify-center gap-2 text-white bg-red-600 cursor-not-allowed rounded-sm shadow hover:shadow-lg" : "p-2 w-1/2 flex items-center justify-center gap-2 text-white bg-primary-orange rounded-sm shadow hover:shadow-lg"}>
                                            <ShoppingBag />
                            ...
                            <div className="flex-1 py-2 px-3">
                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    <h1 className="text-lg sm:text-xl font-medium text-gray-700">{product.name}</h1>
                                    {/* <!-- rating badge --> */}
                                    <div className="flex items-center gap-2 border-b pb-3">
                                        <button className="p-1 text-white font-medium text-sm flex items-center gap-1 rounded-sm bg-primary-blue shadow hover:shadow-lg">{product.ratings} <StarIcon sx={{ fontSize: "16px" }} /></button>
                                        <span className="text-sm text-primary-grey">{product.numOfReviews} Reviews</span>
                                    </div>
                                    {/* <!-- rating badge --> */}
                                    ...
                                    {Array(3).fill("").map((el, i) => (
                                        <p className="text-sm flex items-center gap-1" key={i}>
                                            ...
                                            <span className="font-medium ml-2">Bank Offer</span> 15% Instant discount on Digimart Pay Later order of 500 and above <Link className="text-primary-blue font-medium" to="/">T&C</Link>
                                        </p>
                                    ))}
                                    {/* <!-- banks offers --> */}
